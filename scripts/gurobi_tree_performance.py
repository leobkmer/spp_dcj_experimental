...
parser.add_argument("--weightsolves",nargs="*",type=float,default=[0.1,0.5],help="Solve a weighted version of the ILP first.")
...
weightsolve_time = args.weightsolve_proportion*args.timelim
model.Params.MIPFocus=1
model.Params.MIPGap=1/100
for alph in [0]+args.weightsolves:
    pasttime=time.time()-starttime
    tl = weightsolve_time-pasttime
    if tl < 100:
        print("Less than 100 seconds remaining for weightsolving. Skipping remaining runs.")
        break
